...
import { ChevronsLeft, ChevronsRight, MoreHorizontal, Plus, Settings, Trash2 } from 'lucide-react';
    ...
    >
      ...
      <div className="border-t border-[var(--color-border)] p-2">
        <button
          ...
          className="flex items-center gap-2 w-full px-3 py-2 text-sm text-[var(--color-text-secondary)] rounded-md hover:bg-white/60 transition-colors"
        >
          <Settings size={15} />
          设置
        </button>
